                                    ...
                                    <div >
                                            ...
                                            <div className="form_group_inline" style={{ display: data.identification[index].procedure_type === "Decentralized" || data.identification[index].procedure_type === "Mutual Recognition" ? '' : 'none' }}>
                                                ...
                                                <div className="form_group_field">
                                                    <Select options={contries}
                                                        ...
                                                        placeholder=''
                                                        isClearable
                                                        defaultValue={{label: element.rms, value: element.rms}}
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="inline_form">
                                            <div className="form_group_inline">
                                                ...
                                                <div className="form_group_field">
                                                    <input type="text" name='procedure_num' defaultValue={element.procedure_num} onChange={(e) => handlIdentificationeChange(index, e)} />
                                                </div>
                                            </div>
                                            <div className="form_group_inline">
                                                <span className="form_group_label">Local Tradename</span>
                                                <div className="form_group_field">
                                                    <input type="text" name='local_tradename' defaultValue={element.local_tradename} onChange={(e) => handlIdentificationeChange(index, e)} />
                                                </div>
                                            </div>
                                            <div className="form_group_inline">
                                                ...
                                                <div className="form_group_field">
                                                    ...
                                                    <Select options={[
                                                        ...
                                                        placeholder=''
                                                        isClearable
                                                        defaultValue={{label: element.application_stage, value: element.application_stage}}
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div className="form_group_inline">
                                                ...
                                                <div className="form_group_field">
                                                    <Select options={[
                                                        ...
                                                        placeholder=''
                                                        isClearable
                                                        defaultValue={{label: element.product_type, value: element.product_type}}
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div >
                                            ...
                                            <div className="form_group_inline">
                                                ...
                                                <div className="form_group_field">
                                                    ...
                                                    <Select options={[
                                                        ...
                                                        placeholder=''
                                                        isClearable
                                                        defaultValue={{label: element.variation_reason, value: element.variation_reason}}
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="inline_form">
                                            ...
                                            <div className="form_group_inline">
                                                ...
                                                <div className="form_group_field">
                                                    <input type="text" name='application_number' defaultValue={element.application_number} onChange={(e) => handleVariationChange(index, e)} />
                                                </div>
                                            </div>
                                            <div className="form_group_inline">
                                                <span className="form_group_label">Submission/Procedure N°</span>
                                                <div className="form_group_field">
                                                    <input type="text" name='submission_number' defaultValue={element.submission_number} onChange={(e) => handleVariationChange(index, e)} />
                                                </div>
                                            </div>
                                            <div className="form_group_inline">
                                                ...
                                                <div className="form_group_field" >
                                                    ...
                                                    <Select options={[
                                                        ...
                                                        placeholder=''
                                                        isClearable
                                                        defaultValue={{label: element.submission_format, value: element.submission_format}}
                                                    />
                                                </div>
                                            </div>
                                    ...
                                    <div >
                                        ...
                                        <div className="inline_form">
                                            ...
                                            <div className="form_group_inline">
                                                <span className="form_group_label">Country</span>
                                                <div className="form_group_field">
                                                    <select defaultValue={element.country} name='country' onChange={(e) => CountryStatusEventChange(index, e)}>
                                                        <option value=''></option>
                                        ...
                                        <div className="inline_form">
                                            ...
                                            <div className="form_group_inline">
                                                ...
                                                <div className="form_group_field">
                                                    <input type="text" name="ectd" defaultValue={element.ectd} onChange={e => handleStatusChange(index, e)} />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="inline_form">
                                            <div className="form_group_inline">
                                                ...
                                                <div className="form_group_field">
                                                    <input type="text" name="control" defaultValue={element.control} onChange={e => handleStatusChange(index, e)} />
                                                </div>
                                            </div>
                                            <div className="form_group_inline">
                                                <span className="form_group_label">CCDS/Core PIL ref n°</span>
                                                <div className="form_group_field">
                                                    <input type="text" name="cdds" defaultValue={element.cdds} onChange={e => handleStatusChange(index, e)} />
                                                </div>
                                            </div>
                                            <div className="form_group_inline">
                                                <span className="form_group_label">Remarks</span>
                                                <div className="form_group_field">
                                                    <input type="text" name="remarks" defaultValue={element.remarks} onChange={e => handleStatusChange(index, e)} />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="inline_form">
