...
return [
    ...
    */
    ...
    'contactPerson' => [
        'technical' => [
            'givenName' => env('SAML2_CONTACT_TECHNICAL_NAME', 'Moncef Laftim'),
            'emailAddress' => env('SAML2_CONTACT_TECHNICAL_EMAIL', 'mlaftem@groupekemia.com ')
        ],
        'support' => [
            'givenName' => env('SAML2_CONTACT_SUPPORT_NAME', 'Support'),
            'emailAddress' => env('SAML2_CONTACT_SUPPORT_EMAIL', 'support@groupekemia.com')
        ],
    ],
    ...
    */
    ...
    'organization' => [
        'en-US' => [
            'name' => env('SAML2_ORGANIZATION_NAME', 'Ekemia'),
            'displayname' => env('SAML2_ORGANIZATION_NAME', 'GroupEkemia'),
